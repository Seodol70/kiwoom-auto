    ...
    def run(self) -> None:
        ...
        while self._running:
            ...
            for code, row in top_df.iterrows():
                ...
                # ② 신호 판단 — candidate_codes에만 수행 (sub-method로 분리)
